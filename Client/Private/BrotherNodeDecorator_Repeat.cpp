...
shared_ptr<CBrotherNodeDecorator_Repeat> CBrotherNodeDecorator_Repeat::Create(shared_ptr<CBlackBoard> _pBlackBoard, shared_ptr<CNode> _pNode, function<_bool()> _fpEscape)
{
